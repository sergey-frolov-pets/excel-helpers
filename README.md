...
- [x] <img src="/static/snippets.png" width="75"> [VBA OmniLogger Framework](https://github.com/sergey-frolov-pets/excel-helpers/tree/master/frameworks/vba-omni-logger) - VBA framework for logging events and/or errors from your VBA-code into txt/csv files, Excel range or VBA Immediate window.
- [x] <img src="/static/snippets.png" width="75"> [VBA Profiler](https://github.com/sergey-frolov-pets/excel-helpers/tree/master/frameworks/vba-profiler) - VBA framework which allows you to monitor how long the procedures of your project are running with logging to txt/csv files, Excel range, VBA Immediate window or JSON file.
